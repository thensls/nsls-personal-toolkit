...
echo ""
echo "Tip: Fork thensls/nsls-personal-toolkit to your own GitHub first,"
echo "then set NSLS_PERSONAL_REPO before running this script to install"
echo "from your fork instead."
